...
TC-003: Falha ao Não Preencher campo "name"
...
TC-004: Falha ao Não Preencher campo "location"
...
TC-005: Falha ao Não Preencher campo "dateInitial"
...
TC-006: Falha ao Não Preencher campo "dateFinal"
...
TC-007: Falha com "capacity" Negativa (400)
...
TC-008: Falha com "ageRestriction" Negativa (400)
...
TC-009: Falha com Data Final Anterior à Data Inicial
...
TC-013: Falha com Tipo de Dado Inválido para "name" (Int)
...
TC-014: Falha com Tipo de Dado Inválido para "description" (Booleano)
    [Tags]    ${TAG_ALL_TESTS}    FALHA    TIPAGEM
    ${payload}=    Gerar Payload Tipo Invalido    description    ${TRUE}
    ${response}=    Executar POST e Validar Status    ${payload}    ${STATUS_422}
    # Validar Mensagem de Erro    ${response}    "description" deve ser string

TC-015: Falha com Tipo de Dado Inválido para "capacity" (String)
    [Tags]    ${TAG_ALL_TESTS}    FALHA    TIPAGEM
...
TC-016: Falha com Tipo de Dado Inválido para "ageRestriction" (String)
    [Tags]    ${TAG_ALL_TESTS}    FALHA    TIPAGEM
...
TC-017: Falha com Tipo de Dado Inválido para "dateInitial" (Número)
    [Tags]    ${TAG_ALL_TESTS}    FALHA    TIPAGEM
...
TC-018: Falha com Tipo de Dado Inválido para "dateFinal" (Número)
    [Tags]    ${TAG_ALL_TESTS}    FALHA    TIPAGEM
