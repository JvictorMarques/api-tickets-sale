...
*** Test Cases ***
DELETE-EVENT-001 - Validar impossibilidade de exclusão de evento com ingressos comprados
...
DELETE-EVENT-002 - Validar exclusão de evento com Ticket Type sem ingressos comprados
...
DELETE-EVENT-003 - Validar exclusão de evento sem ticket type cadastrado
